...
export const checkVehicleTax = async (plat: string): Promise<VehicleTaxResponse> => {
    ...
    try {
        const response = await fetch(`${import.meta.env.VITE_SAMBARA_BASE_URL}/sambara/info-pkb`, requestOptions);
